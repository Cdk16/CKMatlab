...
m        = 2500;      % Vehicle mass (kg) — affects inertia and acceleration
P_engine = 150000;    % Engine power (W) — defines available tractive force
...
writematrix([t' v'], 'results/results.csv');
